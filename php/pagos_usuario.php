			...
			<div class="formulario col-10 col-md-8 m-5 py-5 p-md-5 rounded shadow overflow-x-auto">
				<div class="row">
					<div class="col-12 col-md-6">
						<h4><b>Padre de familia:</b> <?php obtenerUsuarioConsulta() ?></h4>
					</div>
					<div class="col-12 col-md-6">
						<h4><b>Nombre:</b> 
							<?php obtenerNombreConsulta() ?>
						</h4>
					</div>
				</div>
				
				<h4 class="my-4">PAGOS REALIZADOS</h4>
				<?php mostrarConsulta ('pagos-PDC') ?>

				<div class="text-center"><a class="btn btn-primary mt-3" href="consultar_pagos.php">Regresar</a></div>
			</div>
		</div>
